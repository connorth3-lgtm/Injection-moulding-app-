...
- manifest domain assets load sequentially in declared order;
- the two remaining learner UI compatibility assets are explicitly allowlisted;
- they load sequentially after domain assets;
