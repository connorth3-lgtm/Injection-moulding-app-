...
| --- | --- | --- | --- | --- |
| Web/PWA | 2026.09.24.15 | current runtime-domain manifest; content 2026.08.26.1; question bank 2026.08.30.1 | shared-origin learner state plus governed IndexedDB domains | automated browser/PWA gates; physical-device and real-AT evidence remain external |
