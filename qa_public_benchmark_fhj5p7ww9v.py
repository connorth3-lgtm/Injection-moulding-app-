...
for marker in ["DATA - COST.xlsx", "publisherSha256", "measuredOutcomeColumns", "derivedOutcomeColumns", "recordLevelMeasuredValues", "acceptedMeasuredTimeSeriesSamples\": 0", "rawRowsOrCellValuesUploadedAsArtifact\": False"]:
