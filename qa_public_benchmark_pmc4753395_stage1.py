...
need(x.get("status") in {"stage1-profile-candidate","stage2-semantic-profile-candidate","accepted-profiled-material-test-traces"},"stage status drifted")
s=x["source"]
...
for marker in ["zipfile.is_zipfile","tensile-data.xlsx","porfiri","rawNumericValuesEmitted","formulaCells","sha256","acceptedMeasuredTimeSeriesSamples\": 0","profile_nested_rar","pmc-oa-opendata.s3.amazonaws.com"]:
