...
const MATERIAL_PRACTICE=[
 ...
 {id:'pet-vs-copolyester',title:'PET and copolyester: family labels do not define one thermal history',level:'Advanced',materials:['PET','Copolyester'],sourceIds:['tritan-eastman','iso-15512'],focus:'Drying, hydrolysis and crystallinity differences',steps:[
  ...
  ['Explain','What is the learning point about polyester family labels?','Polyester chemistry and grade formulation affect hydrolysis and crystallisation, so family names are not production recipes','PET and copolyester are identical','Crystallinity never affects dimensions','Drying can be inferred from dryer temperature alone'] ]},
 ...
 {id:'pmma-optical-stress',title:'PMMA: optical quality needs material and stress evidence',level:'Advanced',materials:['PMMA'],sourceIds:['pmma-plexiglas','pmma-autodesk'],focus:'Optical defects, moisture and moulded-in stress',steps:[
  ...
  ['Explain','What is the core lesson about clear PMMA failures?','Transparent parts can expose several mechanisms at once; optical appearance and structural stress need separate validation','PMMA is not moisture sensitive','Clear parts cannot contain residual stress','Surface polish controls every defect'] ]},
 ...
 {id:'pcabs-grade-identity',title:'PC/ABS: blend name is not a grade specification',level:'Intermediate',materials:['PC/ABS'],sourceIds:['pcabs-covestro','covestro-drying'],focus:'Blend grade identity, moisture and property balance',steps:[
  ...
  ['Explain','What is the core lesson about PC/ABS grade changes?','Polymer-blend family names do not guarantee equivalent flow, drying or end-use properties','Every PC/ABS grade is interchangeable','MFR proves all properties','Blend identity is optional'] ]},
 {id:'hdpe-lot-shrink',title:'HDPE: low moisture uptake does not mean low process sensitivity',level:'Intermediate',materials:['HDPE'],sourceIds:['iso-1133','zhao-2022'],focus:'Crystallinity, shrinkage and lot rheology',steps:[
  ...
  ['Explain','What is the learning point about HDPE lot changes?','Low moisture uptake does not remove crystallinity, rheology and cooling effects on dimensional behaviour','HDPE has no shrinkage','Drying is the only material variable','Pressure alone defines crystallinity'] ]},
