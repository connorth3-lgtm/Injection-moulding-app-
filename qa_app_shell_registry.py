...
need(idx.index("'./app-shell-registry.js'") < idx.index("'./src/domains/runtime-packs/learning-curriculum-runtime-pack.js'"),'registry must capture core before packed learner wrapper modules')
