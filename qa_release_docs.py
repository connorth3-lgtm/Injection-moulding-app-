...
need(pkg.get('devDependencies',{}).get('electron')=='44.3.0','desktop runtime must remain pinned to reviewed Electron 44.3.0')
need(lock.get('packages',{}).get('',{}).get('devDependencies',{}).get('electron')=='44.3.0','desktop lock must resolve reviewed Electron 44.3.0')
...
for marker in ['Electron 44.3.0','Windows 10/11 64-bit','ELECTRON_44_SUPPORT.md','127.0.0.1:43139']:
