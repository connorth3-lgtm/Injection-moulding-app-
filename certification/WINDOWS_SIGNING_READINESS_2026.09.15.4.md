# Windows distribution/signing readiness — 2026.09.15.4

This packet governs the external Windows distribution work associated with MouldMaster web release `2026.09.15.4` at protected-main source commit `f83daaf5b597afc4ef7c1c8ae2653bd7bf67040b`. The separately governed desktop release identity remains `2026.08.26.9` unless deliberately advanced through its own release process.
