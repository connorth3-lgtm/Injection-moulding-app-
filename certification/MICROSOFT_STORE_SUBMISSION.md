...
Current open desktop baseline: `2026.08.26.9`.
...
- [x] Tagged open desktop release lane is configured for `desktop-v2026.08.26.9`
...
- [x] MouldMaster Release QA is configured for desktop release `2026.08.26.9`
- [x] Open Desktop Build is configured for desktop release `2026.08.26.9`
- [x] Question evidence approval is a required package gate
- [ ] Confirm the final `2026.08.26.9` release workflow is green on the exact intended source commit
