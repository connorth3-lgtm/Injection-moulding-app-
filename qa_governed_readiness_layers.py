...
need(n.get("releaseTarget")=="2026.09.18.5","NZQA readiness must target current governed release")
...
need(e.get("release")=="2026.09.18.5","Book enrichment release mismatch")
...
need(version.get("web_release")=="2026.09.18.5","governed readiness layers require web release 2026.09.18.5")
...
need(permit.get("status")=="authorized" and permit.get("release")=="2026.09.18.5","Book enrichment authorization missing")
...
need(sme.get("release")=="2026.09.18.5","Book SME contract release mismatch")
