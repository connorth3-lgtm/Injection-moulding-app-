...
function completeLesson(id){if(!user.completed.includes(id))user.completed.push(id);persist();renderLesson();try{window.dispatchEvent(new CustomEvent("mm:lesson-complete",{detail:{id:String(id)}}))}catch(_){}toast("Lesson completed")}
