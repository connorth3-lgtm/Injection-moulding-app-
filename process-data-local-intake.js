...
const DROP_RE=/(?:^|_)(?:name|email|phone|address|customer|supplier_contact|serial_number|asset_tag|user|username)(?:_|$)/i;
const TIME_RE=/(?:^|_)(?:timestamp|date|datetime|time|created_at|updated_at)(?:_|$)/i;
const ALIAS_RE=/(?:machine|cell|mould|mold|tool|cavity|material|grade|resin|lot|batch|job|work_?order|part_?(?:number|no)|operator)/i;
