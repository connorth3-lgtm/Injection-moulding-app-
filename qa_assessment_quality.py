...
for p in ['certification/QUALITY_AND_ASSESSMENT_MANUAL.md','assessment-storage-scope.js','assessment-quality-suite.js','assessment-stable-review-bridge.js','assessment-analytics-ui.js','assessment-deep-dive.js','assessment-answer-cue-fix.js','training-upgrade.js','MouldMaster_Core_App.html','version.json','sources/QUESTION_BANK_CHANGELOG.md','sources/SOURCE_FRESHNESS.json','qa_source_freshness.py']:
