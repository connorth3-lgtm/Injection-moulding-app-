...
for marker in ['requires the canonical 120-lesson pathway','Mechanism → evidence → decision','Misconception check','Teach-back','duplicate lesson records','Engineering boundary','Safety boundary',"R.after('renderLesson'","R.registerModule('lesson-deep-authoring-v2'"]:
...
print('MouldMaster lesson deep authoring v2 QA passed (120/120 unique lesson-specific records through canonical runtime hook)')
