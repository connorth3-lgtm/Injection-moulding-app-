/* MouldMaster app-shell finalizer — 2026.09.02.4 */
(function(){
'use strict';
...
function loadEngineeringWorkbench(){
  ...
  const next=()=>{
    ...
    const script=document.createElement('script');script.src=`${src}?v=20260902.2-deep200`;script.async=false;script.dataset[key]='1';
