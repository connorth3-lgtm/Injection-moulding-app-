...
/* second-source hardening: every keyed question must resolve to two distinct evidence links */
(function(){
'use strict';
...
E.inferred=function(text){const t=String(text||'').toLowerCase(),out=base(text).map(s=>({...s}));
