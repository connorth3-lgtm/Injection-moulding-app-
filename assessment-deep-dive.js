/* MouldMaster assessment deep dive — 2026-08-24 */
(function(){
'use strict';
...
/* Beginner: retain foundational concepts, but require evidence-based reasoning rather than definition spotting. */
set('Beginner',3,q(
...
/* Intermediate: make the learner distinguish supporting evidence from absolute proof and choose the most diagnostic experiment. */
...
/* Advanced: replace definition-recognition with interpretation under realistic ambiguity. */
set('Advanced',1,q(
...
D.assessmentQA.questionDeepDive={
 ...
 principles:[
  ...
  'Prefer case interpretation over definition recall as difficulty rises.',
  ...
  'Use randomisation/blocking to address time-related confounding in experiments.',
...
window.MM_QUESTION_DEEP_DIVE={version:'2026-08-24',technicalRewrites:12,scenarioRewrites:8,regionalAnswerChanges:0};
})();
