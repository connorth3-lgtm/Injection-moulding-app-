...
function enhance(){
 ...
 host.insertAdjacentHTML('beforeend',`<details data-mm-analytics-review="1" style="margin-top:12px"><summary style="cursor:pointer;color:#72e6cd;font-weight:700">Question-bank analytics detail</summary><div class="grid2" style="margin-top:10px"><div><b>Accuracy by difficulty</b><ul>${diff}</ul></div><div><b>Most-selected wrong distractors</b><ul>${dist}</ul></div></div><div style="margin-top:10px"><b>Exam pass rates</b><ul>${exam}</ul></div><button type="button" class="ghost" style="margin-top:8px" onclick="MM_ASSESSMENT_ANALYTICS_REVIEW.exportJSON()">Export local analytics JSON</button></details>`);
}
