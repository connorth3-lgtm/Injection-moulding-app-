...
must(lesson_v2, ["D.lessons.length!==120", "duplicate lesson records", "Key takeaway", "More detail", "Mechanism", "Evidence chain", "Plant decision", "Misconception check", "Teach-back", "R.after('renderLesson'", "R.registerModule('lesson-deep-authoring-v2'"], "lesson deep authoring v2")
