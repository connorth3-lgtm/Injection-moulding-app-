...
require('RUNTIME_ASSET_VERSION="20260825.5-evidence-startup-order"' in index, "bootstrap must expose the evidence-startup coherent runtime asset version")
...
require("EXPECTED_STATIC_CACHE=\"mouldmaster-static-2026.08.24.1-material-labs-evidence-startup-order-20260825\"" in index, "browser bootstrap must know the current coherent PWA cache")
...
require("CACHE_REVISION='material-labs-evidence-startup-order-20260825'" in service_worker and "${CACHE_VERSION}-${CACHE_REVISION}" in service_worker, "PWA cache revision must stay aligned with the evidence startup fix")
