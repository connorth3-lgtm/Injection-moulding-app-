...
require("EXPECTED_STATIC_CACHE=\"mouldmaster-static-2026.08.24.1-material-labs-mobile-hotfix-20260825\"" in index, "browser bootstrap must know the current coherent PWA cache")
...
require("CACHE_REVISION='material-labs-mobile-hotfix-20260825'" in service_worker and "${CACHE_VERSION}-${CACHE_REVISION}" in service_worker, "PWA cache revision must advance when the offline learning bundle changes")
