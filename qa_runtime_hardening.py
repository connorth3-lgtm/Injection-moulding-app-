...
require('RUNTIME_ASSET_VERSION="20260826.3-evidence-maturity-triangulation"' in index, "bootstrap must expose the evidence-maturity triangulation runtime asset version")
...
require("EXPECTED_STATIC_CACHE=\"mouldmaster-static-2026.08.24.1-evidence-maturity-triangulation-20260826\"" in index, "browser bootstrap must know the current coherent PWA cache")
...
require("CACHE_REVISION='evidence-maturity-triangulation-20260826'" in service_worker and "${CACHE_VERSION}-${CACHE_REVISION}" in service_worker, "PWA cache revision must stay aligned with the evidence maturity triangulation bundle")
