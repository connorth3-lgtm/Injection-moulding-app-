...
require('RUNTIME_ASSET_VERSION="20260826.2-evidence-maturity"' in index, "bootstrap must expose the evidence-maturity coherent runtime asset version")
...
require("EXPECTED_STATIC_CACHE=\"mouldmaster-static-2026.08.24.1-evidence-maturity-20260826\"" in index, "browser bootstrap must know the current coherent PWA cache")
...
require("CACHE_REVISION='evidence-maturity-20260826'" in service_worker and "${CACHE_VERSION}-${CACHE_REVISION}" in service_worker, "PWA cache revision must stay aligned with the evidence maturity bundle")
...
require("'./assessment-evidence-sources.js'" in service_worker and "'./evidence-maturity-deep-dive.js'" in service_worker and "'./lesson-evidence-depth.js'" in service_worker and "'./assessment-evidence-approval.js'" in service_worker, "evidence maturity and approval assets must be available offline")
