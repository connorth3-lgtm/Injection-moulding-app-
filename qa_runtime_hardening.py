...
require("CACHE_REVISION='diagnostic-labs-20260825'" in service_worker and "${CACHE_VERSION}-${CACHE_REVISION}" in service_worker, "PWA cache revision must advance when the offline learning bundle changes")
