...
require("open.dataset.mmDocked='mobile-more-menu-page'" in shell, "mobile reference data launcher must move out of the bottom navigation hit area")
...
require("ensureReferenceDataPage" in shell and "openReferenceDataPage" in shell and "closeReferenceDataPage" in shell, "mobile reference data page lifecycle missing")
require("page.id='mm-reference-data-page'" in shell and "document.querySelectorAll('.main > .view')" in shell, "reference data must use the normal mobile content area rather than overlaying it")
require(".mmrd.mm-reference-data-drawer{display:none!important}" in shell, "reference data modal must be disabled on mobile")
require("#mm-reference-data-page .mmrd-panel" in shell and "overflow:visible!important" in shell, "mobile reference data page must scroll with normal app content")
require("patchReferenceDataPageEvents" in shell and "#mm-reference-data-page .mmrd-close" in shell, "mobile reference data page close handling missing")
require("MM_REFERENCE_DATA_LAUNCHER_DOCK='mobile-more-menu-page'" in shell, "reference data mobile page runtime marker missing")
