...
require('RUNTIME_ASSET_VERSION="20260825.6-lesson-evidence-expansion"' in index, "bootstrap must expose the lesson-evidence coherent runtime asset version")
...
require("EXPECTED_STATIC_CACHE=\"mouldmaster-static-2026.08.24.1-lesson-evidence-expansion-20260825\"" in index, "browser bootstrap must know the current coherent PWA cache")
...
require("CACHE_REVISION='lesson-evidence-expansion-20260825'" in service_worker and "${CACHE_VERSION}-${CACHE_REVISION}" in service_worker, "PWA cache revision must stay aligned with the lesson evidence expansion")
