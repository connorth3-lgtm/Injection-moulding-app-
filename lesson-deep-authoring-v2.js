...
.mm-deep-v2{margin:14px 0;display:grid;gap:8px}.mm-deep-v2-card{border:1px solid #2e4968;border-radius:12px;background:#0e1d31}.mm-deep-v2-essentials{padding:0;overflow:hidden}.mm-deep-v2-row{display:grid;grid-template-columns:126px minmax(0,1fr);gap:14px;align-items:start;padding:13px 15px}.mm-deep-v2-row+.mm-deep-v2-row{border-top:1px solid #263f5c}.mm-deep-v2-row h4{margin:0;font-size:13px;line-height:1.35;color:#f2f7ff}.mm-deep-v2-row p{margin:0;font-size:13px;line-height:1.5;color:#c0d0e3}.mm-deep-v2 details.mm-deep-v2-card{padding:0;overflow:hidden}.mm-deep-v2 details>summary{padding:12px 15px;cursor:pointer;list-style:none}.mm-deep-v2 details>summary::-webkit-details-marker{display:none}.mm-deep-v2 details>summary::before{content:'▸';display:inline-block;margin-right:7px}.mm-deep-v2 details[open]>summary::before{content:'▾'}.mm-deep-v2-detail{padding:2px 15px 14px;border-top:1px solid #263f5c}.mm-deep-v2-detail h4{margin:14px 0 6px}.mm-deep-v2-detail p,.mm-deep-v2-detail li{font-size:13px;line-height:1.55;color:#c0d0e3}.mm-deep-v2-detail ul{padding-left:19px;margin:7px 0}.mm-deep-v2-boundary{padding:11px 13px;border-left:3px solid #d4b25b;background:#292414;color:#f0e1ad;font-size:12px;line-height:1.55}.mm-deep-v2-id{font-size:10px;color:#7f98b8;margin-top:10px}@media(max-width:720px){.mm-deep-v2{margin:11px 0}.mm-deep-v2-row{grid-template-columns:1fr;gap:4px;padding:11px 13px}.mm-deep-v2-row h4{font-size:15px}.mm-deep-v2-row p{font-size:14px;line-height:1.45}.mm-deep-v2 details>summary{padding:11px 13px}.mm-deep-v2-detail{padding:2px 13px 13px}}
