...
def make_signal(field,rows):
    ...
    if not (increasing or decreasing):
        # Authoring candidate only: preserve source order with an explicit source-row axis;
        # final binding must choose a governed coordinate/window rather than silently sort.
