...
need(x.get("status") == "restricted-research-education-profile-candidate", "iGuzzini status drifted")
s = x["source"]
...
print("MouldMaster iGuzzini restricted-use benchmark QA passed")
