...
def main() -> None:
    ...
    need(version.get("web_release") == "2026.09.18.2", "worked-case learner integration requires deliberate web release 2026.09.18.2")
    need(ledger.get("release") == "2026.09.18.2", "worked-case ledger release mismatch")
    ...
    need(sme.get("release") == "2026.09.18.2", "Book SME contract was not advanced with the worked cases")
    ...
    need(worked_auth.get("release") == "2026.09.18.2", "worked-case authorization release mismatch")
    ...
    need("integrated into governed" in lower and "2026.09.18.2" in lower and "learner runtime" in lower, "source pack integration status is stale")
