...
for marker in [
    ...
    'MM_PROCESS_DATA_LOCAL_INTAKE','MAX_ROWS=50000','operator_id','employee_id'
]:
...
const csv='timestamp,machine,mould,material_grade,material_lot,operator_id,customer_name,fill_time_s,cushion_mm,quality_result,comment\\n2026-08-26T10:00:00Z,IMM-A,Tool-X,PA66-GF30,LOT-SECRET,Alice-17,Customer One,1.20,4.5,PASS,first shot\\n2026-08-26T10:00:30Z,IMM-A,Tool-X,PA66-GF30,LOT-SECRET,Bob-22,Customer One,1.24,4.4,FAIL,second shot\\n';
...
for secret in ['imm-a','tool-x','pa66-gf30','lot-secret','alice-17','bob-22','customer one','first shot','second shot','2026-08-26t10:00:00z']:
...
print('MouldMaster local process-data intake QA passed (CSV parse; operator/direct/timestamp stripping; operational aliasing; numeric evidence retention; privacy disclosure; local-only; browser/PWA/desktop packaged)')
