...
function storageHealthHtml(){return storageHealth.ok?'':`<div class="la-warning"><b>Analytics storage needs attention.</b> New learning events may not be saving correctly on this device (${esc(storageHealth.lastError||'storage error')}). Existing learner progress is not deleted; resolve browser/app storage access before relying on these analytics.</div>`}
