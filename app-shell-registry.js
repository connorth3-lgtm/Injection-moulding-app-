...
@media(max-width:700px){
  ...
  .mobile-nav>button:not([data-view]):not([onclick*="openMobileMenu"]):not([data-mm-onclick*="openMobileMenu"]):not(:nth-child(4)){display:none!important}.mobile-nav>button:nth-child(4){display:inline-flex!important}
