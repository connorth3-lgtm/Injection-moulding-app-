...
function installDefaultNavigation(){
  ...
  registerNavigation({id:'book',label:'Book',icon:'▣',description:'Open the evidence-governed MouldMaster Book.',order:45,group:'progress',mobileGroup:'more',action:()=>window.MMBook?.open?.()});
