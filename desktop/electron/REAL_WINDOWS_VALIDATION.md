...
Target release family: open desktop `2026.08.26.9`
...
- the published `MouldMaster-Academy-2026.8.26.9-x64.exe` from the tagged GitHub Release;
...
./desktop/electron/scripts/verify-real-windows-release.ps1 `
  -ExePath 'C:\path\MouldMaster-Academy-2026.8.26.9-x64.exe' `
...
2. Confirm the displayed desktop release is `2026.08.26.9`.
