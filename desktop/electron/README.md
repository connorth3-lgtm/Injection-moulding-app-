...
The bundled learner lifecycle bridge verifies assessment/Learning Insights analytics cleanup before an imported learner registry becomes active and before a factory reset replaces the learner registry. If local storage deletion cannot be verified, those operations fail closed and warn the learner instead of reporting a clean state.
