...
const dynamicLearnerAssets=[
  'ui-shell.css','premium-ui.css','mobile-lesson-fix.css','learner-ux-repair.css','lesson-simple-experience.js','primary-learning-practice-hubs.js','learner-ux-repair.js',
