...
const FILES=[
  ...
  'research-evidence-engine.js','research-evidence-adapter.js','research-evidence-workspace.js','research-evidence-microlearning.js','research-utilisation-analytics.js','research-gap-feedback.js','research-claim-freshness.js','research-evidence-ui.js','research-data-context.js','research-evidence-runtime-health.js',
