...
const FILES=['index.html','MouldMaster_Core_App.html','MouldMaster_Academy_App.html','manifest.webmanifest','mouldmaster-192.png','mouldmaster-512.png','version.json','reading-patch.css','reading-patch.js','training-upgrade.js','training-qa-fix.js','assessment-100-pass.js','pwa-shell.js','source-library.js','reference-data.js','reference-deep-dive.js','reference-research-extension.js','reference-20x-extension.js','reference-sources.js','reference-browser-ui.js','service-worker.js','privacy.html','support.html'];
