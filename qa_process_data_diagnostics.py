...
need('RUNTIME_ASSET_VERSION="20260826.5-guided-data-diagnostics"' in idx,'guided data runtime token not advanced')
need('mouldmaster-static-2026.08.24.1-guided-data-diagnostics-20260826' in idx,'browser expected PWA cache does not match guided data release')

sw=text('service-worker.js')
need("const CACHE_REVISION='guided-data-diagnostics-20260826'" in sw,'PWA cache revision not advanced for guided data diagnostics')
