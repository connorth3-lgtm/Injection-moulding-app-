# MouldMaster real-learner pilot — 2026.09.24.14

This is the execution protocol for `data/learner-pilot-v1.json` and web release `2026.09.24.14`.
...
4. **Book-boundary tasks:** find a relevant Book chapter, interpret an applicable worked example where present, state its assumptions/applicability boundary, distinguish synthetic teaching arithmetic from production evidence, distinguish plausible mechanism from guaranteed cause, and identify when controlling machine/material/mould/site documentation overrides generic guidance.
5. **Standards/readiness boundary:** use the read-only Standards & readiness surface and ask the learner to distinguish learning/QMS support from ISO certification and NZQA provider/consent/moderation/competence evidence.\n6. **Qualitative debrief:** record non-identifying confusion points, navigation friction, confidence shifts and why answers changed.
7. **Delayed transfer:** where feasible, repeat matched tasks after 7–14 days without showing the original answers.
