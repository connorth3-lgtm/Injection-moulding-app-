# NZQA external validation — 2026.09.24.10

Release `2026.09.24.10` has a repository-controlled NZQA readiness layer, but external provider/NZQA validation remains **HOLD**.
